...
<body>
    <table border="3" align="center" width=65%;">
        ...
        <tr>
            ...
            <li> <a href="../manager/manageinformation.php">Managers information</a></li>
            <li> <a href="../manager/managerresponsibility.php">Manager responsibilities</a></li>

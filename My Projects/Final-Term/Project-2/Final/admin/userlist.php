                    ...
                    <?php
                        ...
                        while($res = mysqli_fetch_array($query))
                        {
                            ...
                            <tr>
                                ...
                                <td><a href="edit.php?userid=<?php echo $res['userid'] ?>"><input type="button" value="Edit"></a></td>
                                <td><a href="delete.php?userid=<?php echo $res['userid'] ?>"><input type="button" value="Delete"></a></td>
                            </tr>
                        <?php
                        }
                        ?>
